 ...
 **/
<style scoped>
  .hrt-sidebar-menu .nav > li {
    border-bottom: 1px solid #e7e7e7;
  }
  .hrt-sidebar-menu .nav > li > a {
    background-color: #f8f8f8;
    color: #397ac1;
  }
  .hrt-sidebar-menu .nav > li > a:hover,
  .hrt-sidebar-menu .nav > li > a:focus {
    background-color: #eee;
    color: #29569c;
  }
  .hrt-sidebar-menu .menu-text {
    font-weight: bold;
  }
  .hrt-sidebar-menu .menu-arrow {
    float: right;
    position: relative;
    top: 5px;
    font-size: 12px;
  }
  .hrt-sidebar-menu .sub-nav {
    display: none;
    padding-left: 0;
    margin-bottom: 0;
    list-style: none;
  }
  .hrt-sidebar-menu .sub-nav > li > a {
    display: block;
    padding: 10px 25px;
    color: #397ac1;
  }
  .hrt-sidebar-menu .sub-nav > li > a:hover,
  .hrt-sidebar-menu .sub-nav > li > a:focus {
