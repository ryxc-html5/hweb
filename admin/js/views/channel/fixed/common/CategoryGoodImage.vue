    ...
    <div class="row">
      <div class="col-md-6 text-left">
        <div class="form-group">
          <label>链接类型</label>
          <select class="form-control" v-model="imageData.type" disabled>
            <option v-for="option in urlTypes" :value="option.typeValue" v-if="option.typeValue!=5">{{option.typeName}}</option>
          </select>
        </div>
        <div class="form-group">
          <label>主标题</label>
          <input v-model="imageData.title" type="text" class="form-control" placeholder="">
        </div>
      </div>
      <div class="col-md-6 text-left">
        <div class="form-group">
          <label>{{cUrlTypeLabel}}</label>
          <input v-model="cLinkTo" type="text" class="form-control" placeholder="">
        </div>
        <div class="form-group">
          <label>副标题</label>
          <input v-model="imageData.subTitle" type="text" class="form-control" placeholder="">
        </div>
      </div>
    </div>
    <div class="row">
      <div class="col-md-12 text-center btn-wrapper">
        ...
        <button class="btn btn-primary btn-sm" type="button" @click="del(imageData)">删 除</button>
        <button class="btn btn-primary btn-sm" type="button" @click="up(imageData)">上 移</button>
        <button class="btn btn-primary btn-sm" type="button" @click="down(imageData)">下 移</button>
      </div>
    </div>
  </div>
</template>
