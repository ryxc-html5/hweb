...
<template>
  <div class="panel panel-info">
    <div class="panel-heading">
      <h4 class="panel-title">频道编辑-保健馆</h4>
    </div>
          ...
          <div class="channel-deploy-tab">
            ...
            <ul class="nav nav-tabs" role="tablist">
              ...
              <li role="presentation">
                <a href="#two" aria-controls="two" role="tab" data-toggle="tab">精选推荐</a>
              </li>
              <li role="presentation">
                <a href="#three" aria-controls="three" role="tab" data-toggle="tab">人气活动</a>
              </li>
              <li role="presentation">
                <a href="#four" aria-controls="four" role="tab" data-toggle="tab">人气推荐</a>
              </li>
              <li role="presentation">
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <!--此处放于预览内容-->
            <Bjg-channel-preview :preview-data="previewData"></Bjg-channel-preview>
          </div>
...
<script>
  ...
  import BjgChannelPreview from './BjgChannelPreview';
...
//    getGoodsInfo:"/Admin/ContentManagement/getGoodsInfo",
  ...
  module.exports = {
    ...
    data: function () {
      return {
        ...
        channel:{
          ...
          cmUrl:'',
          cmType:2,
          cmContent:getBjgInitData()
        },
        previewData:$.extend(true, [], getBjgInitData())
      }
    },
    computed: {
    ...
    components: {
      ...
      BjgChannelPreview:BjgChannelPreview
    },
    methods: {
